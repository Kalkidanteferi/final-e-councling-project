        ...
        <form @submit.prevent="handleSubmit(onSubmit)">
          ...
          >
            <div class="md-form">
              <input
                type="text"
                v-model="expert_data.specialization"
          ...
          >
            <div class="md-form">
              <input
                type="text"
                v-model="expert_data.office_location"
...
export default {
  ...
  methods: {
    onSubmit() {
      this.loading = true;
      axios
        .post(`${shared.base_url}/api/users/expertRegister`, this.expert_data)
        .then(() => {
